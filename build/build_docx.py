...
add_para("El canal oficial es GitHub Releases. Link recomendado para compartir: https://github.com/lordodnum/medicion_equipo_remoto/releases/latest/download/MedicionEquipo.exe (siempre última versión). Link versionado: https://github.com/lordodnum/medicion_equipo_remoto/releases/download/v1.3.2/MedicionEquipo.exe")
add_para("El ZIP MedicionEquipo_v1.3.2.zip incluye el EXE y las guías LEEME_EJECUTIVOS.md y README.md. Los checksums SHA256 se publican como checksums.txt y MedicionEquipo.exe.sha256 para verificación de integridad.")
...
add_para("Documento generado automáticamente desde el repositorio medicion_equipo_remoto v1.3.2 — para consultas contactar al área de soporte.", italic=True, size=9, color=RGBColor(0x70,0x70,0x70), align=WD_ALIGN_PARAGRAPH.CENTER)
add_para("Fin del documento.", italic=True, size=9, color=RGBColor(0x70,0x70,0x70), align=WD_ALIGN_PARAGRAPH.CENTER)

out = "dist/Resumen_Jefatura_MedicionEquipo_v1.3.2.docx"
doc.save(out)
